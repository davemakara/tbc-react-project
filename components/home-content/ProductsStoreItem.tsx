...
const ProductsStoreItem = ({ productData }: ProductDataProps) => {
  return (
    <Link href={`/products/${productData.id}`}>
      <div className="p-4 max-w-[350px] bg-white border-4 border-[#000] rounded-lg overflow-hidden transition-all duration-200 ease-in-out hover:shadow-md hover:shadow-[#000] hover:mt-[-8px]">
